/* Depends on jQuery, Color v1.2, linearalgebra v1.3, jquery-linearalgebra-1.0, touch (which requires Hook) */
/* global jQuery, setInterval, Color, window, Point, Box */

(function ($) {
    var $flash, shaking = 0, lastx = 0, lasty = 0;
